              ...
              <h4
                className={`${
                  index % 6 === 0
                    ...
                    : index % 6 === 3
                    ? "max-w-[270px] max-h-[200px] xl:max-w-[421px] 2xl:text-3xl md:max-w-[441px] md:text-2xl mt-2 text-center"
                    : index % 6 === 4
                    ? "max-w-[270px] max-h-[200px] 2xl:max-w-[676px] 2xl:text-3xl xl:max-w-[466px] md:text-2xl md:max-w-[441px] mt-1 text-center"
                    : "max-w-[270px] max-h-[200px] 2xl:max-w-[534px] 2xl:text-3xl xl:max-w-[314px] md:text-2xl md:max-w-[441px] mt-1 text-center"
                }`}
              >
                {realisation.title}
              </h4>
