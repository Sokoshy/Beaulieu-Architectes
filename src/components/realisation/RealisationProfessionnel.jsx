...
const GET_REALISATIONS = gql`
  query RealisationProfessionnel(
    $first: Int
    $after: String
    $name: [String] = "Professionnel"
  ) {
...
export function RealisationProfessionnel() {
    ...
    <section className="w-[280px] mt-8 mx-auto text-[#f8f8f8] 2xl:max-w-screen-2xl xl:max-w-screen-lg md:max-w-[700px]  sm:container">
      <div className="flex flex-col gap-5 items-center text-lg xl:flex-row xl:flex-wrap xl:gap-0 xl:items-stretch lg:text-xl  2xl:text-2xl">
        {realisations.map((realisation, index) => (
          <Link to={`/realisation/${realisation.slug}`} key={realisation.id}>
            <article
              key={realisation.id}
              className={`${
                index % 6 === 0
            ...
            >
              ...
              <h4
                className={`${
                  index % 6 === 0
                    ? "max-w-[270px] max-h-[200px] 2xl:max-w-[501px] 2xl:text-3xl  xl:max-w-[401px] md:max-w-[441px] md:text-2xl  mt-1 text-center"
                    : index % 6 === 1
                    ? "max-w-[270px] max-h-[200px] 2xl:max-w-[676px] 2xl:text-3xl  xl:max-w-[476px] md:max-w-[441px] md:text-2xl  mt-1 text-center"
                    : index % 6 === 2
                    ? "max-w-[270px] max-h-[200px] 2xl:max-w-[622px] 2xl:text-3xl  xl:max-w-[422px] md:max-w-[441px] md:text-2xl  mt-1 text-center"
                    : index % 6 === 3
                    ? "max-w-[270px] max-h-[200px] 2xl:text-3xl xl:max-w-[421px]  md:max-w-[441px] md:text-2xl  mt-2 text-center"
                    : index % 6 === 4
                    ? "max-w-[270px] max-h-[200px]  2xl:max-w-[676px] 2xl:text-3xl xl:max-w-[466px] md:max-w-[441px] md:text-2xl  mt-1 text-center"
                    : "max-w-[270px] max-h-[200px] 2xl:max-w-[534px]  2xl:text-3xl xl:max-w-[314px] md:max-w-[441px] md:text-2xl  mt-1 text-center"
                }`}
              >
                {realisation.title}
              </h4>
